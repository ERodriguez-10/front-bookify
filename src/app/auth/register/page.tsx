...
export default function RegisterPage() {
  return (
    <div className="flex h-full min-h-screen items-center justify-center bg-gradient-to-t from-slate-900 to-slate-700">
      <div className="box-shadow: 0 2.8px 2.2px rgba(0, 0, 0, 0.034), 0 6.7px 5.3px rgba(0, 0, 0, 0.048), 0 12.5px 10px rgba(0, 0, 0, 0.06), 0 22.3px 17.9px rgba(0, 0, 0, 0.072), 0 41.8px 33.4px rgba(0, 0, 0, 0.086), 0 100px 80px rgba(0, 0, 0, 0.12) min-w-[450px] rounded-2xl bg-white text-black">
        <h1 className="pt-8 text-center text-4xl font-bold">
          <i className="fa-solid fa-lock me-2"></i>
          Auth
        </h1>
        <p className="mb-6 mt-3 text-center text-gray-600">Create an account</p>
        ...
        >
          ...
          <label htmlFor="user_lastname" className="mt-4 font-bold">
            Last Name
          </label>
          <input
            type="text"
          ...
          <label htmlFor="user_age" className="mt-4 font-bold">
            Age
          </label>
          <input
            type="number"
        ...
        <div className="mt-6 flex items-center justify-center">
          <hr className="w-1/3" />
          <p className="mx-4 text-gray-600">Or register with</p>
          <hr className="w-1/3" />
        </div>
